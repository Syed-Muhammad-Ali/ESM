...
import 'package:european_single_marriage/services/stripe_service.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class Membership extends StatelessWidget {
  Membership({super.key});
  final membershipCtrl = Get.put(MembershipController());
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Obx(() {
        if (membershipCtrl.isLoading.value) {
          return const Center(
